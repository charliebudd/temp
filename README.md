...
I've chosen to train a simple adapter to evaluate DinoV3 in surgery. Despite the simple adaptation, the model performs reasonably well acheiving mIoU of 0.687 on the test split. Here's a break down of the approach...
